                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/area/doEdit/'.$this->uri->segment(4); ?>" role="form"> 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="txtArea" value="<?php echo $dataDetail['nama_area']; ?>" placeholder="Isi area" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Koordinat latitude 1</label>
                            <div class="col-sm-9">
                                <input type="text" id="txtKoor1" name="txtKoor1" value="<?php echo $dataDetail['latlong_a']; ?>" placeholder="Isi koordinat latitude 1" class="col-xs-10 col-sm-5" required readonly/>
                            </div>
                        </div>
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Koordinat latitude 2</label>
                            <div class="col-sm-9">
                                <input type="text" id="txtKoor2" name="txtKoor2" value="<?php echo $dataDetail['latlong_b']; ?>" placeholder="Isi koordinat latitude 2" class="col-xs-10 col-sm-5" required readonly/>
                            </div>
                        </div>
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Koordinat latitude 3</label>
                            <div class="col-sm-9">
                                <input type="text" id="txtKoor3" name="txtKoor3" value="<?php echo $dataDetail['latlong_c']; ?>" placeholder="Isi koordinat latitude 3" class="col-xs-10 col-sm-5" required readonly/>
                            </div>
                        </div>
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Koordinat latitude 4</label>
                            <div class="col-sm-9">
                                <input type="text" id="txtKoor4" name="txtKoor4" value="<?php echo $dataDetail['latlong_d']; ?>" placeholder="Isi koordinat latitude 4" class="col-xs-10 col-sm-5" required readonly/>
                            </div>
                        </div>
