                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/siswa/doAdd/'?>" role="form"> 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="txtNamasiswa" value="<?php echo $dataOld['txtNamasiswa']; ?>" placeholder="Isi nama siswa" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
                        <div class="form-group">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="password" id="form-field-1" name="txtPassword" value="<?php echo $dataOld['txtPassword']; ?>" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
