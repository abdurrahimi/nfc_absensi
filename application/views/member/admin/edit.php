                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/siswa/doEdit/'.$this->uri->segment(4); ?>" role="form"> 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="txtNIK" value="<?php echo $dataDetail['nik']; ?>" placeholder="Isi NIK" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
                        <div class="form-group">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="password" id="form-field-1" name="txtPassword" value="<?php echo $dataDetail['password']; ?>" class="col-xs-10 col-sm-5" required/>
                                <input type="hidden" id="form-field-1" name="txtPasswordLama" value="<?php echo $dataDetail['password']; ?>" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="id_area" class="col-xs-10 col-sm-5" required>
                                    <option value="">Select Area</option>
                                    <?php foreach ($this->db->from('area')->get()->result() as $key => $value) { ?>
                                        <option value="<?= $value->id_area ?>" <?= ($dataDetail['id_area']==$value->id_area?'selected':'') ?>><?= $value->nama_area ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
